...
//+
Physical Surface("LeftFaceG") = {{124}};
//+
Physical Surface("RightFaceG") = {{122}};
//+
Physical Surface("FrontFaceG") = {{123}};
//+
Physical Surface("BackFaceG") = {{125}};
//+
Physical Surface("LeftFaceA") = {{119}};
//+
Physical Surface("RightFaceA") = {{121}};
//+
Physical Surface("FrontFaceA") = {{127}};
//+
Physical Surface("BackFaceA") = {{120}};
//+
Physical Surface("TopCoreA") = {{49}};
//+
Physical Surface("FrontCoreA") = {{43}};
//+
Physical Surface("BackCoreA") = {{48}};
//+
Physical Surface("LeftCoreA") = {{45}};
//+
Physical Surface("RightCoreA") = {{40}};
//+
Physical Surface("DataTop") = {{26}};
//+
Physical Surface("DataBottom") = {{1}};
//+
Physical Surface("DataFront") = {{25}};
//+
Physical Surface("DataBack") = {{17}};
//+
Physical Surface("DataLeft") = {{21}};
//+
Physical Surface("DataRight") = {{13}};
//+
Physical Surface("BottomCoreG") = {{39}};
//+
Physical Surface("LeftCoreG") = {{35}};
//+
Physical Surface("RightCoreG") = {{30}};
//+
Physical Surface("FrontCoreG") = {{33}};
//+
Physical Surface("BackCoreG") = {{38}};
//+
Physical Surface("BufferGround") = {{117}};
//+
